...
Particle.prototype = {
  ...
  display: function() {
    ...
    this.ctx.moveTo(x + radius + this.corners[0].x, y + this.corners[0].y * absCosA );
    this.ctx.quadraticCurveTo(
      x + width - radius  + this.corners[1].x - 2,
      y + this.corners[1].y * absCosA - 3,
      x + width - radius  + this.corners[1].x,
      y + this.corners[1].y * absCosA
    );

    this.ctx.lineTo(x + width + this.corners[2].x, y + height - radius + this.corners[2].y * absCosA);
    this.ctx.quadraticCurveTo(
      x + radius + this.corners[3].x - 3,
      y + height + this.corners[3].y * absCosA - 2,
      x + radius + this.corners[3].x,
      y + height + this.corners[3].y * absCosA
    );

    this.ctx.lineTo(x + this.corners[0].x , y + radius + this.corners[0].y * absCosA);
    this.ctx.quadraticCurveTo(x + this.corners[0].x, y + this.corners[0].y * absCosA, x + radius + this.corners[0].x, y + this.corners[0].y * absCosA);
